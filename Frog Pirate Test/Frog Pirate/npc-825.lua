...
--If the NPC dies and it has baby mario, return him to yoshi
function sampleNPC.onNPCKill(killedNPC,eventObj,v,reason,culprit)
if yiYoshi.playerData.babyMario.state == 1 then
if killedNPC.id == 825 then
yiYoshi.playerData.babyMario.state = 0
yiYoshi.playerData.starCounterState = 0
end
end
end
...
--Keep Mario attached to the NPC
if yiYoshi.playerData.babyMario.state == 1 then
yiYoshi.playerData.babyMario.speedY = v.y
yiYoshi.playerData.babyMario.speedX = v.x
end

if yiYoshi.playerData.babyMario.state == 2 then
